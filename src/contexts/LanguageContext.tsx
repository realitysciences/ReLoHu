...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'process.step2.text': 'An unscripted conversation — questions emerge from what you say, not a fixed protocol. The presence of a genuine witness activates a different mode of self-expression. You go deeper than you would alone.',
