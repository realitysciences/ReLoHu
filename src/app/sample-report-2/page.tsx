          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-8 md:px-14 pb-12 space-y-12">
              ...
              <div>
                ...
                <P>His instinct is outreach, broadcast, scale — which is real. His gift, however, is the moment of encounter. The stranger on Instagram who couldn't stop. The Freemason hall, the hockey rink with executives, the church where synchronicity walked through the door. <R w="md" /> creates conditions for magic by being fully himself in whatever room he enters.</P>
