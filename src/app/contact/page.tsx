                ...
                <CardContent className="p-10 flex flex-col items-center justify-center text-center h-full gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 leading-relaxed max-w-sm">
                      Thank you for reaching out. Dr. David will get back to you personally. In the meantime, feel free to book an orientation call if you'd like to talk sooner.
                    </p>
                  </div>
                  <a
                    href="/#cta-section"
            ...
            <Card className="bg-gradient-to-br from-teal-600 to-teal-700 border-0 shadow-lg text-white">
              <CardContent className="p-7">
                ...
                <p className="text-teal-100 text-sm leading-relaxed mb-5">
                  The fastest way to get your questions answered is a 15–20 minute orientation call with Dr. David. No commitment. Just a conversation.
                </p>
                <a
                  href="/#cta-section"
            ...
            <Card className="bg-white border-slate-100 shadow-sm">
              <CardContent className="p-7">
                ...
                <p className="text-slate-500 text-sm leading-relaxed mb-4">
                  Prefer to write directly? Every message goes to Dr. David personally.
                </p>
                <a
