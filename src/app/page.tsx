      ...
      <section className="py-16 px-6 bg-slate-900">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-slate-400 leading-relaxed mb-8 max-w-lg mx-auto">
            {lang === 'en'
              ? 'Answer five questions in David\'s voice. Submit your email. Receive a short written portrait of what you shared, generated by the same AI methodology behind every full Terrain Map. No commitment, no sales follow-up.'
            ...
            <div className="px-8 pt-8 pb-6 border-b border-slate-100">
              ...
              <div className="space-y-3">
                {(lang === 'en' ? [
                  ...
                  { icon: Clock,     text: '90-minute intake conversation with David' },
                  { icon: FileText,  text: 'Five detailed reports delivered as documents you keep' },
                  { icon: BookOpen,  text: '30-minute Terrain Map reading session with David' },
                ] : [
                  { icon: Phone,     text: 'Llamada de orientación de 15 min, gratis, sin compromiso' },
                  { icon: Clock,     text: 'Conversación de intake de 90 minutos con David' },
                  { icon: FileText,  text: 'Cinco reportes detallados entregados como documentos' },
                  { icon: BookOpen,  text: 'Sesión de lectura del Terrain Map de 30 minutos con David' },
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex items-start gap-2">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  {lang === 'en'
                    ? 'The Terrain Map is written by AI running on David\'s proprietary prompts and clinical frameworks, not a generic tool.'
                    : 'El Terrain Map es escrito por IA que ejecuta los prompts propietarios y marcos clínicos del David, no una herramienta genérica.'}
                </p>
              </div>
            </div>
            {/* Price + CTA */}
          ...
          <div className="mt-0 border border-teal-700/50 bg-teal-900/30 rounded-2xl px-7 py-5 flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-slate-400 text-sm leading-relaxed space-y-2">
                {lang === 'en' ? (
                  <>
                    <p><span className="text-slate-300 font-medium">On the input side:</span> The questions asked during the intake session are David's, designed to surface what matters, reach what is usually avoided, and create the conditions for genuine disclosure. What gets said is shaped by how he asks.</p>
                  ...
                  <>
                    <p><span className="text-slate-300 font-medium">En el lado de entrada:</span> Las preguntas durante la sesión son del David, diseñadas para revelar lo que importa y crear condiciones para la divulgación genuina.</p>
      ...
      <section className="py-20 px-6 bg-white border-t border-slate-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <p className="text-sm text-slate-500 font-medium tracking-wide">David, Founder of ReLoHu</p>
            <div className="w-8 h-px bg-teal-300" />
          </div>
        </div>
      </section>
          ...
          <Card className="max-w-md mx-auto bg-white border-slate-200 shadow-xl rounded-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-teal-600 to-teal-500 p-4 text-white text-center">
              ...
              <p className="font-medium">
                {lang === 'en' ? 'Orientation Call with David' : 'Llamada de Orientación con David'}
              </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <p className="font-medium text-slate-800">David</p>
