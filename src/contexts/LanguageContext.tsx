...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'pain.subtitle': "You haven't lacked good practitioners. You've lacked a clear map of who you are. Without it, even the most skilled professional is starting in the dark.",
    ...
    'process.step1.text': 'We talk about where you are, what brought you here, and what the process looks like. No commitment. No pressure. Just a conversation to see if this feels right.',
    'process.step2.title': 'Intake Session with Dr. David',
    'process.step2.duration': 'Up to 2 hours',
    'process.step2.text': 'A real, human, one-on-one conversation — conducted by Dr. David personally, every time. Not a questionnaire. Not an AI. The questions emerge from what you say. Nothing is scripted. You speak, and someone actually stays with what you said.',
    'process.step3.title': 'Terrain Map Delivery',
    'process.step3.duration': '30 min',
    'process.step3.text': 'Everything you shared comes back as a written document — your patterns, your access points, your resistance zones, laid out clearly. A portrait you keep.',
    'process.step4.title': 'What Comes Next',
    'process.step4.text': 'The Terrain Map stands on its own. It is also the document you hand to any new therapist or practitioner so you never have to start from scratch again. Further sessions are available if you want to go deeper.',
  ...
  es: {
    ...
    'pain.subtitle': 'No te han faltado buenos profesionales. Lo que te ha faltado es un mapa claro de quién eres. Sin él, incluso el profesional más hábil comienza en la oscuridad.',
    ...
    'process.step1.duration': '15-20 min',
    'process.step1.text': 'Hablamos sobre dónde estás, qué te trajo aquí, y cómo es el proceso. Sin compromiso. Sin presión. Solo una conversación para ver si esto se siente bien.',
    'process.step2.title': 'Sesión de Intake con Dr. David',
    'process.step2.duration': 'Hasta 2 horas',
    'process.step2.text': 'Una conversación real, humana, uno a uno — conducida por Dr. David personalmente, siempre. No un cuestionario. No una IA. Las preguntas emergen de lo que dices. Nada es guionado. Hablas, y alguien realmente se queda con lo que dijiste.',
    'process.step3.title': 'Entrega del Terrain Map',
    'process.step3.duration': '30 min',
    'process.step3.text': 'Todo lo que compartiste regresa como un documento escrito — tus patrones, tus puntos de acceso, tus zonas de resistencia, presentados con claridad. Un retrato que conservas.',
    'process.step4.title': 'Lo Que Sigue',
    'process.step4.text': 'El Terrain Map tiene valor por sí solo. También es el documento que le entregas a cualquier nuevo terapeuta o profesional para nunca tener que empezar desde cero. Hay sesiones adicionales disponibles si quieres ir más profundo.',
