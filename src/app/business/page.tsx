      ...
      <section className="py-20 px-6 bg-slate-900">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-5 text-slate-400 leading-relaxed">
            <p>
              ReLoHu is a single 90-minute conversation with Dr. Gedalia, followed by five written reports delivered as documents you keep. There is no ongoing therapeutic relationship. No weekly sessions. No process of slowly building disclosure over months.
            </p>
            <p>
      ...
      <section className="py-20 px-6 bg-teal-700">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-teal-100 leading-relaxed mb-10 max-w-lg mx-auto">
            A 15-minute orientation call with Dr. Gedalia is free and requires nothing. If ReLoHu is the right tool for where you are, you'll know quickly.
          </p>
