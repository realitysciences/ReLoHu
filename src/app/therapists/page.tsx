      ...
      <section className="py-20 px-6 bg-slate-900">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-5 text-slate-400 leading-relaxed">
            <p>
              ReLoHu is a single mapping session conducted by Dr. David, a doctoral-level practitioner and founder of the methodology. It produces a set of reports. It is not an ongoing treatment relationship. It does not diagnose, prescribe, or treat.
            </p>
            <p>
      ...
      <section className="py-20 px-6 bg-slate-50 border-y border-slate-100">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { step: '1', title: 'Client books an orientation call', body: 'A free 15-minute call with Dr. David. No commitment. The client decides whether ReLoHu feels right for them before any session is booked.' },
              { step: '2', title: '90-minute intake session', body: 'A deep conversation with Dr. David. Not a questionnaire. Dr. David listens carefully to what the client says and how they say it, then analyzes the session using the ReLoHu methodology.' },
              ...
              { step: '4', title: '30-minute Terrain Map reading', body: 'Dr. David walks the client through the Terrain Map on a dedicated call, so they arrive at your office having already processed the initial picture.' },
            ].map(({ step, title, body }) => (
      ...
      <section className="py-20 px-6 bg-teal-700">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-teal-100 leading-relaxed mb-10 max-w-lg mx-auto">
            A 15-minute orientation call with Dr. David costs nothing. View a sample report first, or book a call directly to discuss whether ReLoHu is the right fit for your practice.
          </p>
