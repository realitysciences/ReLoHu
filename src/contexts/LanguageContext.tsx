...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'ai.subtitle': 'Su metodología existe en ambos extremos: diseñó las preguntas que extraen los datos, y los marcos que los interpretan. La IA aplica ambos. A través de todo, el preguntar y el leer, el Dr. Gedalia está presente.',
    'ai.q1': '¿No es esto solo "AI slop"?',
    'ai.a1': 'El "AI slop" ocurre cuando prompts genéricos producen resultados genéricos. ReLoHu es lo opuesto. El sistema fue construido sobre años de input clínico de alta calidad: preguntas específicas, marcos específicos, patrones interpretativos específicos, desarrollados por el Dr. Gedalia durante una década de práctica. Una IA genérica dada una transcripción produce una respuesta genérica. Este sistema fue construido para producir un retrato.',
    'ai.q2': '¿Por qué importa la conversación humana?',
    'ai.a2': 'La calidad del mapa depende completamente de la calidad de la entrada. Los seres humanos se revelan de manera diferente en el diálogo que por escrito. El rol del Dr. Gedalia como entrevistador es crear las condiciones donde dices las cosas que son realmente verdaderas, no las que has ensayado.',
    'ai.q3': '¿Qué construyó exactamente el Dr. Gedalia?',
