...
const faqGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'Is Dr. Gedalia acting as a therapist or AI prompt engineer during the session?',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'That\'s exactly what the orientation call is for. It\'s 15–20 minutes with Dr. Gedalia, no commitment, no pressure. Just a conversation to understand where you are and whether ReLoHu makes sense for you right now.',
      },
    ],
  },
]
      ...
      <section className="relative pt-32 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-500 max-w-xl mx-auto leading-relaxed">
            Everything you need to know before your first conversation with Dr. Gedalia.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-slate-500 mb-8 leading-relaxed">
            The orientation call is the best place to get them answered. 15–20 minutes with Dr. Gedalia, no commitment, just a conversation.
          </p>
          <a
            href="/#cta-section"
