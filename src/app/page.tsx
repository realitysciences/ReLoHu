        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-slate-400 leading-relaxed mb-8 max-w-lg mx-auto">
            {lang === 'en'
              ...
              : 'Responde cinco preguntas. Recibe un retrato escrito breve de lo que compartiste, generado por la misma metodologia de IA detras de cada Terrain Map completo. Sin compromiso, sin seguimiento de ventas.'}
          </p>
          <a
            href="/mini-map"
