    ...
    items: [
      {
        ...
        a: 'The current offer is the Founding Cohort — $997 for the first ten public clients. This includes the intake session, verbal readback during the session, your Terrain Map delivered as a file, and a 30-minute follow-up call scheduled 30 days after the session. The follow-up call is exclusive to the founding cohort and will not be included once those ten spots are filled.',
      },
      {
        q: 'What happens to pricing after the founding cohort closes?',
        a: 'After the ten founding cohort spots are filled, the standard Terrain Map session — intake, readback, and Terrain Map — will be available at $997 without the follow-up call. The price stays the same. What changes is the follow-up call is no longer included.',
      },
      {
