...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'process.step2.text': 'A real, human, one-on-one conversation — conducted by Dr. David personally, every time. Not an AI. Not a questionnaire. An unscripted conversation where questions emerge from what you say. No judgment. No advice. No homework. Just you being heard, completely.',
  ...
  es: {
    ...
    'process.step2.text': 'Una conversación humana, real, uno a uno — conducida por Dr. David personalmente, siempre. No una IA. No un cuestionario. Una conversación sin guión donde las preguntas emergen de lo que dices. Sin juicio. Sin consejos. Solo tú siendo escuchado, completamente.',
